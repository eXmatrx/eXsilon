...
private:
  ...
  private:
    ...
    ImageView m_ImageLogoFirst;
    ImageView m_ImageLogoSecond;
  };

  static constexpr KDCoordinate k_topMargin = 100;
  ...
  static constexpr int k_numberOfColumns = 3; // deprecate this
