...
TitleBarView::TitleBarView() :
  View(),
  m_titleView(KDFont::SmallFont, I18n::Message::Default, 0.5f, 0.5f, KDColorWhite, Palette::Blue),
  m_preferenceView(KDFont::SmallFont, 1.0f, 0.5, KDColorWhite, Palette::Blue)
{
...
void TitleBarView::drawRect(KDContext * ctx, KDRect rect) const {
  ...
  ctx->fillRect(KDRect(0, 0, bounds().width(), 2), Palette::Blue);
}
